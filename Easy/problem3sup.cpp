...
EasyAccuracy: 49.11%Submissions: 94K+Points: 2
...
// Return True if the given trees are isomotphic. Else return False.
    bool isIsomorphic(Node *r,Node *s)
    {
    //add code here.
        if(r==NULL&&s==NULL){
            return 1;
        ...
        bool a=isIsomorphic(r->left,s->left);
        bool b=isIsomorphic(r->right,s->right);
        bool c=isIsomorphic(r->left,s->right);
        bool d=isIsomorphic(r->right,s->left);
